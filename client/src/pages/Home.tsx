              ...
              {testimonials.map((test) => (
                ...
                >
                  ...
                  <div className="pt-3 border-t border-slate-100 flex items-center gap-3">
                    <div className="w-9 h-9 rounded-full bg-navy-900 text-brand-gold font-bold flex items-center justify-center text-xs">
                      {test.name.charAt(0)}
                    </div>
                    <div>
                      <h4 className="font-bold text-navy-900 text-xs sm:text-sm">{test.name}</h4>
